...
<body >
								...
								<div class="row">
									...
									<div class="col-md-3" >
										<span class="top-right-links pull-right">
												...
												<span><img src="new-file.png" alt="new file" class="new-file"/></span>
										</span>
									</div>
									<div class="col-md-4">
								...
								<div class="panel-body">
									<div class="row">
										...
										<div class="col-md-9">
											<div class="row">
												<div class="col-md-12">
													<span><h4>Uday Pratap Singh</h4></span>
												</div>								
											</div>
											<div class="row">
												<div class="col-md-12">
	...
	<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#sendInvitation">Open Modal</button>
	...
	<div class="modal-dialog">
		...
		<div class="modal-body ">
				...
				<div class="row">
					...
					<div class="col-md-8 form-group">
						<textarea  class="form-control select-border" id="Description" placeholder="Description"></textarea>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4 form-group">
